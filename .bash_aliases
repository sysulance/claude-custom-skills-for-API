...
alias file-history='python3 ~/.claude/custom-skills/file-history-browser/scripts/file_history.py'
...
alias project-search='python3 ~/.claude/custom-skills/cross-project-search/scripts/cross_project_search.py'
