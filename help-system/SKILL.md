...
python3 ~/.claude/skills/help-system/scripts/help_system.py

# Get help for specific skill
python3 ~/.claude/skills/help-system/scripts/help_system.py todo-manager
python3 ~/.claude/skills/help-system/scripts/help_system.py session-manager

# Show all available commands
python3 ~/.claude/skills/help-system/scripts/help_system.py --commands

# Show help about skills in general
python3 ~/.claude/skills/help-system/scripts/help_system.py --about
```
